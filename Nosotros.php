    ...
    ?>
      <body class="fondobody">
        ...
        <div class="Container">
            <div class="card ">
            <div class="card-body">
                <h5 class="card-title mar">Dark Cube</h5>
                <p class=" ptext">Encuentra los mejores articulos de cultura pop con nosotros. </p>
        ...
        <div class="Container">
            <div class="card ">
            <div class="card-body">
                <h5 class="card-title mar">Para contactar con nosotros: </h5>
                <p class=" ptext"> darkcube@outlook.com</p>
        ...
        <div class="container ">
                 <div class="card box w-100">
                    <p class="mar">Ubicación en Nuevo Casas Grandes </p>
