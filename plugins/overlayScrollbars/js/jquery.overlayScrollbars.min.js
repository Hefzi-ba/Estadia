    ...
    Tt =
      ...
      (f = {}),
      {
        ...
        u: function (n) {
          ...
          for (
            var r, e, i, o = l(n), a = mt.createElement("div")[gi.s], u = 0;
            u < c.length;
            u++
          )
            for (
  ...
  var i,
    ...
    w =
              ...
              for (var a in t)
                if (t[gi.hOP](a) && n[gi.hOP](a)) {
                  ...
                  if (((x = x === bi ? {} : x), y && S == yt))
                    ...
                    for (v = 0; v < w[gi.l]; v++)
                      if (
                        ((s = w[v]), (c = (m = R(s)) == _t && -1 === A(s, L)))
                      )
                        for (
                          k.push(_t), u = s.split(" "), O = O.concat(u), d = 0;
                          d < u[gi.l];
                          d++
                        ) {
                          for (
      ...
      (yi.extension = function (n, t, r) {
        ...
        if (e)
          if (mi.type(t) == wt)
            y.push({ name: n, extensionFactory: t, defaultOptions: r });
          else
            for (; o < y[gi.l]; o++)
              if (y[o].name === n) {
  ...
  function z(r, n, t, kt, Ot) {
      ...
      return (
              ...
              a
                ? n === Te
                  ? ((t = (function u() {
                    ...
                    (e = t || r) && ni({ k: r, O: It ? bi : Gt }))
                  : n === hn
                  ? Qr
                    ? ((i = T(S.takeRecords())), (o = k(z.takeRecords())))
                    : (i = Ct.update(Te))
                  : "zoom" === n && ni({ C: !0, k: !0 })
                : ((n = Kt || n),
                  (Kt = !1),
        ...
        (Ct.scroll = function (n, t, r, e) {
          ...
          function U(n, t) {
            ...
            if (
              (e = a
                ? (2 < t[H] && ((o = t.substr(0, 2)), -1 < ln(o, x) && (r = o)),
                  (t = (t = r ? t.substr(2) : t)
                    [v](/min/g, 0)
                    [v](/</g, 0)
                    [v](/max/g, (s ? "-" : ze) + Oe)
          ...
          if (I || M) {
            ...
            if (0 < (p = I ? D : Si(D))[H]) {
              ...
              if (
                ($t &&
                  (Nt.n || Nt.i || (en.x = xi.round(nn[me] - tn[me] + Q)),
                  Nt.n && w && (en.x *= -1),
                  Nt.i && w && (en.x = xi.round(nn[me] - tn[me] + (vn.R - Q)))),
                y.x != k || y.y != k || m.x == A || m.y == A || $t)
              ) {
                var on = p[0],
                  an = sn
                    ? on[gi.bCR]()
        ...
        yi.valid(
          (function bt(n, t, r) {
            ...
            return (
              ...
              At.x && At.y && !Gt.nativeScrollbarsOverlaid.initialize
                ? (ui("onInitializationWithdrawn"),
                  v && (it(!0), at(!0), ft(!0)),
                  (Kt = Mt = !0))
                : (jt &&
                    (((e = {}).l = xi.max(Zt[Ae](), d[Ae](), u[Ae]())),
                    (e.t = xi.max(Zt[He](), d[He](), u[He]())),
                    (i = function () {
                  ...
                  (function l() {
                    ...
                    function a(n) {
                      if (f(n)) {
                        var t = c(n),
                          r = {};
                        (ue || ae) && (r[xe] = i.w + (t.x - e.x) * o.x),
                          (fe || ae) && (r[_e] = i.h + (t.y - e.y) * o.y),
                          nr.css(r),
                          mi.stpP(n);
                      } else u(n);
                    }
                  ...
                  jt &&
                    ...
                    mt.activeElement == n &&
                      hr.focus &&
                      (ir.attr(gi.ti, "-1"), hr.focus(), Xn(ir, B, i, !1, !0))),
                  Ct.update(Te),
                  (It = !0),
                  ui("onInitialized"),
                  c(En, function (n, t) {
    ...
    function $e(n, t) {
      if (n) {
        ...
        if (t) {
          if (A)
            ((O = n.addClass("observed").append(si(_n)).contents()[0])[Z] =
              new r(a)).observe(O);
          else if (9 < D || !Rt) {
            n.prepend(
              si(
                ...
                si(
                  { c: Sn, dir: "ltr" },
                  si(Sn, si(zn)) +
                    si(Sn, si({ c: zn, style: "width: 200%; height: 200%" }))
                )
              )
            );
            var u,
              ...
              x = {},
              _ = {};
            fi(_, ze, [-2 * (g.y + 1), -2 * g.x, -2 * g.y, -2 * (g.x + 1)]),
              Si(s).css(_),
              d.on(ke, w),
              v.on(ke, w),
              n.on(e, function () {
              ...
              return (
                n !== R &&
                  ((r =
                    "ltr" === n
                      ? ((t[me] = 0), (t[be] = Te), o)
                      : ((t[me] = Te), (t[be] = 0), Nt.n ? -o : Nt.i ? 0 : o)),
    ...
    function ni(n) {
      ...
      if (
        ...
        if (
          ...
          x &&
            (pi(nr, Br + Ce + Ve),
            hi(nr, w !== bi && null !== w && 0 < w.length ? w : Ve)),
          L &&
            (!0 === R || (null === R && Rt)
              ? (Ge(), Ot.add(Ct))
              : (Ot.remove(Ct), Ke())),
        ...
        if (
          ...
          var xn = {},
            ...
            z
              ? (fi(xn, ze, [$.t, $.r, $.b, $.l]), fi(Et ? _n : pn, de))
              : (fi(xn, ze), fi(Et ? _n : pn, de, [$.t, $.r, $.b, $.l])),
            er.css(xn),
            Zt.css(_n);
        }
        le = mn();
        var Sn = !!Et && Ze(),
          zn = Et && f(Sn, Yr),
          Tn = Et && Sn ? { w: I ? Sn.B : Sn.U, h: E ? Sn.V : Sn.q } : {};
        if (
          ((Yr = Sn),
          ...
          rn
            ...
            : (bn[xe] = ze),
          an
            ? (hn.ch || (pn[we + _e] = ze), (bn[_e] = Tn.h || pr[gi.cH]))
            : (bn[_e] = ze),
          C && ur.css(bn),
          or.css(pn),
          (pn = {}),
          ...
          var Rn = li(),
            ...
            Wn = Rn[gi.sW],
            Dn = Rn[gi.sH];
          Lt || ((An[ge] = fn ? ze : Nn), (An[K] = on ? ze : Hn), ir.css(An)),
            (le = mn());
          var In = gn(),
            Mn = {
          ...
          var Pn = Et && (0 === le.w || 0 === le.h),
            ...
            Jn = function (n) {
              ...
              (qn[e] = "v-s" === W[e]),
                (Bn[e] = "v-h" === W[e]),
                (Vn[e] = "s" === W[e]),
                (Xn[e] = xi.max(0, xi.round(100 * (Fn[i] - le[i])) / 100)),
                (Xn[e] *= Pn || (f && 0 < u && u < 1) ? 0 : 1),
                (Yn[e] = 0 < Xn[e]),
                ($n[e] = qn[e] || Bn[e] ? Yn[r] && !qn[r] && !Bn[r] : Yn[e]),
                ($n[e + "s"] = !!$n[e] && (Vn[e] || qn[e])),
                (Kn[e] = Yn[e] && $n[e + "s"]);
            };
          if (
              ...
              (Yn.c || $n.c || Fn.c || V || en || un || rn || an || N) &&
                ...
                (Qn = function (n) {
                  ...
                  At[e] && Yn[e] && $n[e + "s"]
                    ? ((pn[ve + i] = !o || H ? ze : Ht[e]),
                      (pn[he + i] =
                        (n && o) || H ? ze : Ht[e] + "px solid transparent"))
                    : ((nt[r.j] = pn[ve + i] = pn[he + i] = ze), (tt = !0));
                }),
          ...
          if (
            ...
            ((Yn.x && $n.x && !At.x) || (Yn.y && $n.y && !At.y))
              ? ((et[de + pe] = se.x),
                ...
                (et[de + G] = se.y),
                (et[ve + G] = -se.y))
              : (et[de + pe] = et[ve + pe] = et[de + G] = et[ve + G] = ze),
            (et[de + K] = et[ve + K] = ze),
            (Yn.x && $n.x) || (Yn.y && $n.y) || Pn
              ? Et && Pn && (xn[On] = xn[Cn] = "hidden")
              : (!k || Bn.x || qn.x || Bn.y || qn.y) &&
                (Et && (xn[On] = xn[Cn] = ze), (et[On] = et[Cn] = "visible")),
            er.css(xn),
            ir.css(et),
            (et = {}),
          ...
          if (((pn = {}), V || en || un))
            if ($t && rn) {
              ...
              or.css(Se, ot),
                at !== xi.round(or.position().left) && (pn[me] = at);
            } else pn[me] = ze;
          if ((or.css(pn), Et && i)) {
            var ut = (function Tt() {
            ...
            if (ut) {
              ...
              (c.x = -1 < bt.x ? ($t && Ur && Nt.i ? 0 : bt.x) : c.x),
                (c.y = -1 < bt.y ? bt.y : c.y);
            }
            Xr = ut;
          }
          ...
          ($n.x || $n.y ? hi : pi)(nr, We),
            ...
            S &&
              ...
              oe
                ...
                : (pi(nr, Re),
                  hi(cr, Pe),
                  ae ? hi(cr, Ue) : ue ? hi(cr, qe) : fe && hi(cr, Be))),
            (d || D || $n.c || Yn.c || N) &&
              (H
                ? N && (pi(nr, Le), H && (_t(), St()))
                : yt
                ...
                : mt && (_t(), St())),
            (p || N) &&
              (ie || ee ? (Je(!0), Je()) : Je(!0), te ? ri(!0) : ri(!1, !0)),
            (e || Xn.c || un || en || S || Y || T || N || V) &&
              (ei(!0), ii(!0), ei(!1), ii(!1)),
            g && oi(!0, b),
            y && oi(!1, m),
            V && ui("onDirectionChanged", { isRTL: $t, dir: B }),
            e && ui("onHostSizeChanged", { width: br.w, height: br.h }),
            i && ui("onContentSizeChanged", { width: gr.w, height: gr.h }),
            (Yn.c || $n.c) &&
            ...
            Xn.c && ui("onOverflowAmountChanged", { x: Xn.x, y: Xn.y });
        }
        jt &&
          Gr &&
          (yr.c || Gr.c) &&
    ...
    function it(e) {
      var n = "parent",
        ...
        u = [rn, en, Re, Ne, on, an, un, Le, We, De, Ie, Ve, fn, Tn, qr].join(
          Ce
        ),
        f = {};
      ...
      var n,
        ...
        o = function (n) {
          var t = vt(kn + Ce + (n ? Wn : Dn), !0),
            r = vt(On, t),
            e = vt(An, t);
          return v || i || (t.append(r), r.append(e)), { rn: t, en: r, in: e };
        };
      function r(n) {
        var t = ai(n),
          r = t.rn,
    ...
    function ut(_) {
      ...
      function R(n) {
        if (
          ...
          (T = 1),
          s(),
          S !== (z = i = bi) && (Ct.scrollStop(), clearTimeout(S), (S = bi)),
          n)
        ) {
          var t = sr[gi.bCR]();
          (n.clientX >= t.left &&
      ...
      if ((clearTimeout(O), n)) pi(f, Rn), pi(p, Rn);
        ...
        var r,
          e = function () {
            j ||
              Mt ||
              (!(r = h.hasClass("active") || g.hasClass("active")) &&
                (re || ee || ie) &&
                hi(f, Rn),
              !r && (re || ee || ie) && hi(p, Rn));
          };
