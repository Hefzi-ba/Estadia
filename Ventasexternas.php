        ...
        <div class="row mb-2">
          ...
          <table class="table table-responsive">
              ...
              <th class="letrasmenu" scope="col">Eliminar</th>
                ...
                $consulta =
                    "SELECT carrito.id, carrito.usuario, carrito.fecha, carrito.totalpagar, carrito.idusuario, carrito_productos.id_producto,ropa.nombre,ropa.imagen, carrito.lugar FROM carrito INNER JOIN carrito_productos ON carrito.id=carrito_productos.id_carrito INNER JOIN ropa on carrito_productos.id_producto=ropa.id WHERE serviciodomicilio=1 ";
