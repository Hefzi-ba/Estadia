      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <table class="table table-responsive">
            ...
            $consulta="SELECT carrito.id, carrito.usuario, carrito.fecha, carrito.totalpagar, carrito.idusuario, carrito_productos.id_producto,ropa.nombre FROM carrito INNER JOIN carrito_productos ON carrito.id=carrito_productos.id_carrito INNER JOIN ropa on carrito_productos.id_producto=ropa.id WHERE serviciodomicilio=0 ";
            ...
            while($arreglo=mysqli_fetch_array($respuesta)){
              echo '
                <tr>
                  ...
                  <td scope="row">'.$arreglo['nombre'].'</td>
